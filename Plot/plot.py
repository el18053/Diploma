...
for match in matches:
    ...
    page_cache_misses.append(int(page_cache_miss))
...
plt.figure(figsize=(15, 8))  # Set the figure size to 10 inches by 6 inches
...
plt.xticks([r + barWidth for r in range(len(file_sizes))], file_sizes, rotation=10)  # Rotate x-axis labels by 45 degrees
plt.legend()
plt.grid(True)
